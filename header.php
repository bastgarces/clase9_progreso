...
<title><?php echo $title = "Compra de medicamentos en Chile";?></title>
...
<li<?php if((basename($_SERVER['PHP_SELF']))=='page_1.php'){?> class="active" <?php };?>><a href="page_1.php">Cenabast</a></li>
<li<?php if((basename($_SERVER['PHP_SELF']))=='page_2.php'){?> class="active" <?php };?>><a href="page_2.php">Algunos Hospitales de Santiago</a></li>
</ul>
</nav>
</div>
</div>
